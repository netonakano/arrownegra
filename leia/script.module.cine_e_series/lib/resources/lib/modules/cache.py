...
def _find_cache_version():
    ...
    try:
        ...
        import xbmc
        print 'cine_e_series Addon Data Path Does not Exist. Creating Folder....'
        ad_folder = xbmc.translatePath('special://home/userdata/addon_data/plugin.video.cine_e_series')
    ...
    try:
        curVersion = control.addon('script.module.cine_e_series').getAddonInfo('version')
