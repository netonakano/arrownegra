...
#                if not i['source'].lower() in self.hosthqDict and i['quality'] not in ['SD', 'SCR', 'CAM']: i.update({'quality': 'SD'})
    ...
    def getConstants(self):
        self.itemProperty = 'plugin.video.cine_e_series.container.items'

        self.metaProperty = 'plugin.video.cine_e_series.container.meta'
        ...
        sourceDir1 = cine_e_seriesscrapers.sources()
        ...
        try:
            if scraperSetting == 'cine_e_series Scrapers':
            ...
            elif scraperSetting == 'cine_e_series + Built-in':
                ...
                self.sourceDict = sourceDir1
                self.module_name = oas_module_name
                control.setSetting('module.provider', 'cine_e_series Scrapers')
        except:
            return
